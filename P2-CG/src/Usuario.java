...
public class Usuario {
	...
	public enum TipoDeUsuario {
		...
		TipoDeUsuario(double desconto, String tipo) {
			valorDoDesconto = desconto*this.valorDoDesconto;
			tipoDeUsuario = tipo;
		}
	}
	...
	public void comprarJogo(Jogo jogo) {
		...
		this.dinheiroQuePossui -= jogo.valor*this.getDesconto();
	...
	public void imprimeInformacoesUsuario() {
		...
		for (Jogo jogo : jogosComprados) {
			System.out.println("+ " + jogo.nome + "- " + jogo.tipoDeJogo + ":"
					...
					+ "Total de preço de jogos:" + this.dinheiroGasto);
		}
		
	}

	public double getDesconto() {
		return this.tipoDeUsuario.valorDoDesconto;
	}
